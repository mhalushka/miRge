...
def summarize(seqDic, sampleList, logDic, mirDic, file_mirna, outputdir, spikeIn, bowtieBinary):
	...
	#print "mirDic has %d keys"%(len(mirDic.keys()))
	#print "hsa-miR-21-5p in mirDic:"
	#print 'hsa-miR-21-5p' in mirDic.keys()
	...
	for i in range(len(sampleList)):
		...
		logDic['quantStats'][i].update({'maturetrnaReads': 0})
		logDic['quantStats'][i].update({'pretrnaReads': 0})
			...
			if seqDic[seqKey]['quant'][i] != 0:
				...
				if seqDic[seqKey]['annot'][1] != '' or seqDic[seqKey]['annot'][9] != '':
					...
					if seqDic[seqKey]['annot'][1] != '':
						...
						mirDic[seqDic[seqKey]['annot'][9]]['quant'][i] = mirDic[seqDic[seqKey]['annot'][9]]['quant'][i] + seqDic[seqKey]['quant'][i]
					...
					logDic['quantStats'][i]['maturetrnaReads'] = logDic['quantStats'][i]['maturetrnaReads'] + seqDic[seqKey]['quant'][i]
				elif seqDic[seqKey]['annot'][4] != '':
					logDic['quantStats'][i]['pretrnaReads'] = logDic['quantStats'][i]['pretrnaReads'] + seqDic[seqKey]['quant'][i]
